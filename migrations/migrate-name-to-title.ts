/**
 * Run this script from within project folder e.g: `sanity exec migrations/script.ts --with-user-token`
 *
...
const fetchDocuments = () =>
  client.fetch(
    `*[(_type == 'therapyResource' || _type == 'supportGroup' || _type == 'podcast' || _type == 'app' || _type == 'forum' || _type == 'memorial' || _type == 'peerSupport') && defined(name)][0...100] {_id, _rev, name}`
  );
