...
const fetchDocuments = () =>
  client.fetch(
    `*[defined(resourceDetails)][0...100] {_id, _rev, resourceDetails}`
  );
...
const buildPatches = (docs: any) =>
  docs.map((doc: any) => ({
    ...
    patch: {
      ...
      set: {
        resourceUrl: doc.resourceDetails.resourceUrl,
        sourceWebsite: doc.resourceDetails.source,
        categories: doc.resourceDetails.categories,
        populations: doc.resourceDetails.populations,
      },
      unset: ["resourceDetails"],
